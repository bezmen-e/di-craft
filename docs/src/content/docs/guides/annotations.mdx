---
title: Use class annotations
description: Attach explicit provider metadata to class-based services without reflection.
---

import CodeBlock from '../../../components/CodeBlock.astro';
import injectableExample from '../../../../examples/annotations/injectable.ts?raw';
...
The complete annotation example is type-checked as part of the docs workspace.

<CodeBlock code={injectableExample} title="examples/annotations/injectable.ts" />
